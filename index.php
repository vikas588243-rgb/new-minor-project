...
// Check for login status (for navbar logic)
...
<head>
    ...
    <title>The Daily Dose Podcast - Your Daily Source of Inspiration</title>
...
<body class="antialiased">
    <div class="fixed top-0 left-0 right-0 z-50">
        <header class="bg-white/30 backdrop-blur-md shadow-md rounded-full mx-auto max-w-7xl mt-4 px-8 py-3 flex items-center justify-between relative">
            ...
            <nav id="main-nav" class="hidden md:flex flex-grow justify-center items-center space-x-6 md:space-x-8">
                ...
                <a href="#episodes-section" class="nav-link text-gray-600 hover:text-gray-900 font-medium transition duration-300">Episodes</a>
                ...
                <a href="#about-section" class="nav-link text-gray-600 hover:text-gray-900 font-medium transition duration-300">About Us</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden fixed top-24 left-4 right-4 bg-white/90 backdrop-blur-lg rounded-xl shadow-lg p-6 flex flex-col space-y-4 z-40">
        <nav class="flex flex-col space-y-2">
            ...
            <a href="#episodes-section" class="nav-link text-gray-600 hover:text-indigo-700 font-medium transition duration-300">Episodes</a>
            ...
            <a href="#about-section" class="nav-link text-gray-600 hover:text-indigo-700 font-medium transition duration-300">About Us</a>
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="https://picsum.photos/seed/podcast/1920/1080.jpg" alt="Hero background" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-black/50"></div>
        </div>
        <div class="relative z-10 text-center text-white px-4">
            <h1 class="text-4xl md:text-6xl font-bold mb-4">Welcome to The Daily Dose</h1>
            <p class="text-xl md:text-2xl mb-8">Your daily source of inspiration and knowledge</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#episodes-section" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition duration-300">
                ...
                <a href="#about-section" class="inline-flex items-center justify-center px-8 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-white hover:text-gray-900 transition duration-300">
                    Learn More
                </a>
            </div>
        </div>
    ...
    <section id="episodes-section" class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Latest Episodes</h2>
                <p class="text-xl text-gray-600">Discover our most recent podcast episodes</p>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php
                // Fetch latest videos from database with error handling
                $sql = "SELECT v.*, u.username FROM videos v JOIN users u ON v.user_id = u.id ORDER BY v.upload_date DESC LIMIT 6";
            ...
            <div class="text-center mt-12">
                <a href="trending.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    View All Videos
                </a>
            </div>
        </div>
    ...
    <section id="about-section" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">About The Daily Dose</h2>
                    <p class="text-lg text-gray-600 mb-6">
                        Welcome to The Daily Dose, your premier destination for inspiring content, thought-provoking discussions, and expert insights. Our mission is to bring you the best in podcast entertainment, covering topics that matter to you.
                    </p>
                    <p class="text-lg text-gray-600 mb-8">
                        Whether you're looking for personal development, industry trends, or just a good story, we've got you covered with fresh content delivered daily.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#episodes-section" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Start Listening
                        </a>
                        <a href="contact.php" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Contact Us
                        </a>
                    </div>
                </div>
                <div class="relative">
                    <img src="https://picsum.photos/seed/about/600/400.jpg" alt="About us" class="rounded-lg shadow-xl">
                </div>
            </div>
        </div>
    </section>
